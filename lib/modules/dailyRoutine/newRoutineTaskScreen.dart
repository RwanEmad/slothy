...
class newRoutineTaskScreen extends StatefulWidget {
  const newRoutineTaskScreen({Key? key}) : super(key: key);
...
class _newRoutineTaskScreenState extends State<newRoutineTaskScreen> {
  ...
  var routinDiscriptionController = TextEditingController();
  ...
  var endDateColor = Color.fromARGB(181, 92, 142, 171);
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(
                      horizontal: 20.0, vertical: 10),
                  child: TextField(
                    controller: routinDiscriptionController,
                    ...
                    decoration: InputDecoration(
                      enabledBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              color: Color.fromARGB(122, 76, 75, 75),
                              width: 2)),
                          ...
                          onTap: () {
                            setState(() {
                              if (colorsList[index] == Color.fromARGB(45, 149, 149, 149)) {
                                ...
                                endDateColor = Color.fromARGB(181, 92, 142, 171);
                              } else {
                                repeatColor = colorsList[index];
                                endDateColor = supColorsList[index];
                              }
                            });
                          },
                          child: Padding(
